#include "stereo_projection_factor.h"

Eigen::Matrix4d StereoProjectionFactor::sqrt_info;
...
StereoProjectionFactor::StereoProjectionFactor(const Eigen::Vector3d &_pts_i,
                                   ...
                                   const Eigen::Vector3d &_pts_i_r,
                                   const Eigen::Vector3d &_pts_j_r) : pts_i(_pts_i), pts_j(_pts_j), pts_i_r(_pts_i_r), pts_j_r(_pts_j_r)
{
#ifdef UNIT_SPHERE_ERROR
...
bool StereoProjectionFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    TicToc tic_toc;
...
void StereoProjectionFactor::check(double **parameters)
{
#if 0
