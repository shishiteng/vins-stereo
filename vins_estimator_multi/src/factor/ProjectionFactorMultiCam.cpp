#include "ProjectionFactorMultiCam.h"
...
ProjectionFactorMultiCam::Evaluate( const double* const* parameters, double* residuals, double** jacobians ) const
{
    ...
    norm_jaco <<
        ...
        if ( jacobians[0] )
        {
            ...
            jaco_i2j.rightCols< 3 >( )  = ric2.transpose( ) * Rj.transpose( ) * Ri * - Utility::skewSymmetric( pts_imu_i );
            // clang-format on
        ...
        if ( jacobians[1] )
        {
            ...
            jaco_j2.rightCols< 3 >( ) = ric2.transpose( ) * Utility::skewSymmetric( pts_imu_j ); // pts_imu_jr
            // clang-format on
        ...
        if ( jacobians[3] )
        {
            ...
            jaco_ex1.rightCols< 3 >( ) = ric2.transpose( ) * Rj.transpose( ) * Ri * ric1
                                         * -Utility::skewSymmetric( pts_camera_i1 );
        ...
        if ( jacobians[4] )
        {
            ...
            jaco_ex2.rightCols< 3 >( ) = Utility::skewSymmetric( pts_camera_j2 );
