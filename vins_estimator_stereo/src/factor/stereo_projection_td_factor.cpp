#include "stereo_projection_td_factor.h"

Eigen::Matrix2d StereoProjectionTdFactor::sqrt_info;
double StereoProjectionTdFactor::sum_t;

StereoProjectionTdFactor::StereoProjectionTdFactor(const Eigen::Vector3d &_pts_i, const Eigen::Vector3d &_pts_j, 
...
bool StereoProjectionTdFactor::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    TicToc tic_toc;
...
void StereoProjectionTdFactor::check(double **parameters)
{
